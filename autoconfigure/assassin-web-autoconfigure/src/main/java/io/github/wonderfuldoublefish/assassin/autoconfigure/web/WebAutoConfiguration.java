 ...
 * assassin-web 自动装配入口.
 *
 * <p>在 Servlet Web 环境下启用以下能力（均可通过 {@code assassin.web.*} 配置启停）：
 * <ul>
...
public class WebAutoConfiguration {
  ...
  @ConditionalOnProperty(
      prefix = "assassin.web.response-wrapper",
      name = "enabled",
      havingValue = "true",
      matchIfMissing = true)
  @ConditionalOnClass(
      name = "org.springframework.http.converter.json.JacksonJsonHttpMessageConverter")
  ...
  @ConditionalOnMissingBean
  @ConditionalOnProperty(
      prefix = "assassin.web.exception-handler",
      name = "enabled",
      havingValue = "true",
      matchIfMissing = true)
