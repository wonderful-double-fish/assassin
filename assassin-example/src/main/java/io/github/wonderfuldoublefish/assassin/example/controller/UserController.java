 ...
 * 示例用户接口。
 *
 * <p>用于演示 assassin-web 自动装配效果：{@code list()} 返回的普通 POJO 会被包装为统一响应体，
 * {@code error()} 抛出的业务异常会被全局异常处理器捕获。</p>
 */
@RestController
...
public class UserController {
    ...
    public List<User> list() {
        return List.of(new User(1234567890123456789L, "Alice",
                LocalDateTime.of(2026, 9, 9, 12, 30, 0), null));
    }

    /**
     * 触发业务异常的示例端点。
     *
     * <p>该接口必然失败，用于验证全局异常处理器的返回结构。</p>
     */
    @GetMapping("/error")
    public void error() {
